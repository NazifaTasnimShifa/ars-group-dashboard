      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
                ...
                <input type="date" name="acquisitionDate" id="acquisitionDate" defaultValue={asset?.acquisitionDate || ''} required className="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600"/>
            </div>
            <div>
