...
import FilterButtons from '@/components/ui/FilterButtons'; // ✅ NEW IMPORT
  ...
  return (
    <DashboardLayout>
      ...
      <Modal
        ...
        title={`${modalState.mode === 'add' ? 'Add' : 'Edit'} Sale`}
      >
            ...
            <div className="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
              <table className="min-w-full divide-y divide-gray-300">
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {sales.map((s) => (
                    <tr key={s.id}>
                      <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-indigo-600 sm:pl-0 hover:underline cursor-pointer">
                        {s.id}
                      </td>
